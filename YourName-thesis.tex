...
%%      \cochairI{Jason Swarts}
%%      \cochairII{Chris Cox}
%%
\chair{Jason Swarts}
\memberI{Stacey Pigg}
\memberII{Adriana de souza e Silva}
\memberIII{Casie Fedukovich}   % unnecessary if committeesize=3
\memberIV{Monica Leggoe}    % unnecessary if committeesize=3 or 4
\memberV{Monica Leggoe}    % unnecessary if committeesize=3 or 4


%% Student writing thesis, \student{First Middle}{Last}
\student{Nupoor R.}{Ranade} % a full middle name
%\student{Nupoor R.}{Ranade} % a middle initial

%% Degree program
\program{Communication, Rhetoric and Digital Media}
...
\thesistitle{A North Carolina State University Thesis \break 
with a Title So Long it Needs a Line Break}
